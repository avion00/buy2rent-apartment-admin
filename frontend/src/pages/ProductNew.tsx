                    ...
                    <div className="space-y-4">
                      <div className="grid gap-4 md:grid-cols-2">
                        <div className="space-y-2">
                          ...
                          >
                            ...
                            <SelectContent>
                              <SelectItem value="DPD Hungary">
                                DPD Hungary
                              </SelectItem>
                              <SelectItem value="GLS Hungary">
                                GLS Hungary
                              </SelectItem>
                              <SelectItem value="Sameday Courier Hungary">
                                Sameday Courier Hungary
                              </SelectItem>
                            </SelectContent>
                          </Select>
                        </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            setFormData({
                              ...formData,
                              delivery_time_window: e.target.value,
                            })
                          }
                      ...
                      <div className="pt-2">
                        ...
                        <div className="grid gap-4 md:grid-cols-3">
                          <div className="space-y-2">
                            <Label htmlFor="deliveryContactPerson">
                              Contact Person
                            </Label>
                            <Input
                              ...
                              onChange={(e) =>
                                setFormData({
                                  ...formData,
                                  delivery_contact_person: e.target.value,
                                })
                              }
